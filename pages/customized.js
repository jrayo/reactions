...
export default function Home({ reactions }) {
  return (
    <div className='container'>
      <Head>
        <title>Static Reactions Demo Custom</title>
      ...
      <main>
        ...
        <ol>
          <li>
            Each Next.js page can define the timeout. For this page, it’s set as an environment variable at {process.env.NEXT_PUBLIC_REVALIDATE_TIMEOUT} seconds.
          </li>
          <li>
